# -*- coding: utf-8 -*-
#
# WebStore Client documentation build configuration file, created by
...
htmlhelp_basename = 'WebStoreClientdoc'
...
latex_documents = [
  ('index', 'WebStoreClient.tex', u'WebStore Client Documentation',
...
man_pages = [
    ('index', 'webstoreclient', u'WebStore Client Documentation',
